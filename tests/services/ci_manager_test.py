        ...
        workers=[
            CiWorkerSummary(
                ...
                current_job=CiJobSummary(
                    commit_url=HttpUrl(
                        "https://github.com/repo_owner_in_progress_1/repo_name_in_progress_1/commit/ref_in_progress_1"
                    )
                ),
            ),
            CiWorkerSummary(
                ...
                current_job=CiJobSummary(
                    commit_url=HttpUrl(
                        "https://github.com/repo_owner_in_progress_2/repo_name_in_progress_2/commit/ref_in_progress_2"
                    )
                ),
            ),
        ],
